## TASK-1024: capture Compliance front door: arch audit --report generates
**Meta:** P3 | L | READY | Focus:no | 2-code-generation | local | docs/tasks/
**Depends:** none
...
- cli/src/main/ts/domain/models/outcome.ts _(core)_
- cli/src/main/ts/domain/models/stability.ts _(core)_

...
**Meta:** P1 | S | READY | Focus:no | 2-code-generation | claude | cli/src/main/ts/application/use-cases/create-task.ts, cli/src/main/ts/application/commands/capture-command.ts
**Depends:** none

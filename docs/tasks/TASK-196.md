...
**Meta:** P1 | S | IN_PROGRESS | Focus:yes | 2-code-generation | claude-code [LOCK:gemini-cli] | cli/src/main/ts/application/commands/task-command.ts, cli/src/test/ts/, docs/agents/DO.md
**Depends:** none

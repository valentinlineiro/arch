...
**Meta:** P1 | M | REVIEW | Focus:no | 2-code-generation | claude | cli/src/main/ts/application/commands/task-command.ts, .arch/context-index.json, docs/adr/, docs/tensions/

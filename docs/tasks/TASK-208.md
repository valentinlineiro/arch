...
**Meta:** P2 | M | READY | Focus:no | 2-code-generation | claude-code | docs/agents/DO.md, docs/AGENTS.md, docs/adr/, cli/src/main/ts/application/use-cases/mark-task-done.ts
**Depends:** TASK-207

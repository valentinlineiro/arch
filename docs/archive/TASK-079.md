...
**Meta:** P0 | S | 5 | DONE | Focus:yes | 7-operations | cli | cli/
**Depends:** none
...
### Definition of Done
- [x] The CLI development environment is fully functional.
- [ ] `arch review` passes (pre-existing warning from TASK-078 uncommitted diff — not caused by this task).

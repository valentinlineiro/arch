...
**Closed-at:** 2026-06-02T21:34:58.122Z
...
- [x] Intent addressed
  - `prose: verified`
- [x] INBOX regeneration path verifies each READY/IN_PROGRESS/REVIEW task file exists at `docs/tasks/TASK-XXX.md`; tasks found only in `docs/archive/` are excluded from active counts and flagged with `INBOX_STATE_MISMATCH` in `.arch/escalations.jsonl`
  - `prose: verified`

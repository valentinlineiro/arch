...
- Modify any file in `docs/guidelines/` directly — propose via `idea:` prefix (creates a draft in `docs/refinement/`) or raise during THINK mode (Phase 3 Continuous Kaizen)

...
Links are stored in the context index (from TASK-219) and surfaced in task context feedback and `arch ask` queries.
...
## Dependencies
TASK-219 (Auto Context Engine / ContextIndex).

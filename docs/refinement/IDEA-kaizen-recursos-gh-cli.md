...
## Gaps
- **Ubicación:** ¿Es mejor un archivo nuevo `docs/resources/gh-cli.md` o integrarlo directamente en `AGENTS.md` para visibilidad inmediata?
- **Mantenimiento:** Los enlaces externos pueden romperse. ¿Deberíamos incluir ejemplos de comandos comunes (Cheat Sheet) localmente?

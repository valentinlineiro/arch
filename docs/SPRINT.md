...
**Goal:** Modular Architecture and Continuous Kaizen
**Committed:** 2 tasks
**Velocity target:** —
...
**Meta:** P1 | L | READY | Sprint 3 | 2-code-generation | claude-code | docs/
**Depends:** TASK-027

### Acceptance Criteria
- [ ] Directory structure established: docs/tasks/, docs/guidelines/, docs/archive/.
- [ ] Migration script to split monolithic files into modules.
- [ ] arch review and arch validate updated to work with the modular structure.
...
- [ ] Protocol for 'Real-time Guideline Proposal': AI can propose a guideline change as soon as a pattern is detected.
